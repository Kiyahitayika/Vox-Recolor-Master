...
/mob/living/proc/rejuvenate()
	...
	message_admins(src)
	message_admins(human_mob)
	message_admins(rgb(src.dna.GetUIValueRange(DNA_UI_SKIN_R, 255), src.dna.GetUIValueRange(DNA_UI_SKIN_G, 255), src.dna.GetUIValueRange(DNA_UI_SKIN_B, 255)))
	restore_all_organs()
