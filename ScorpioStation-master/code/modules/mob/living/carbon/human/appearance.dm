...
/mob/living/carbon/human/proc/change_skin_color(var/colour = "#000000")
	if(colour == skin_colour || !(dna.species.bodyflags & HAS_SKIN_COLOR) || !(dna.species.bodyflags & HAS_LOCKED_SKIN_COLOR))		//Iren Code - look here
		return

	skin_colour = colour // HERE - IREN CODE
	message_admins(skin_colour)
...
/mob/living/carbon/human/proc/change_skin_tone(var/tone)
	if(s_tone == tone || !((dna.species.bodyflags & HAS_SKIN_TONE) || !(dna.species.bodyflags & HAS_LOCKED_SKIN_COLOR)))		//Iren Code
		return
